...
export type Page = 'home' | 'projects' | 'deadlines' | 'knowledge' | 'learning'

const PAGES: { id: Page; label: string; path: string; icon: string }[] = [
  ...
  { id: 'deadlines', label: 'Deadlines', path: '/deadlines', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  ...
  { id: 'learning', label: 'Learning', path: '/learning', icon: 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm0 0v7' },
]
